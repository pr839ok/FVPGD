(function() {
    ...
    function rers(json, argument) {
        ...
        $('#tabular-download-tabular').attr('href', '/webhdfs/v1' + json.outputFile_tabular + '?op=PUBDB_BLASTNFILEDOWNLOAD&temp=' + temp);
        $('#tabular-download-pair').attr('href', '/webhdfs/v1' + json.outputFile_asn + '?op=PUBDB_BLASTNFILEDOWNLOAD&temp=' + temp);
